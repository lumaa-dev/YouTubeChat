...
class ChatService implements StreamChatService
{
    ...
    public void start(final String videoId, final String clientSecret)
    {
        ...
        this.executor.execute(() ->
        {
            try
            {
                ...
                ModLogger.printYTMessage(StreamChat.json.text("Service started").setStyle(StreamChat.json.green()), ConfigManager.getInstance().getRightSideChat());
            }
            catch (Throwable t)
            {
    ...
    public void subscribe(YouTubeChatMessageListener listener)
    {
        if (!this.listeners.contains(listener))
        {
            ...
            ModLogger.printYTMessage(StreamChat.json.text("Started receiving live chat message").setStyle(StreamChat.json.white()), ConfigManager.getInstance().getRightSideChat());
    ...
    public void unsubscribe(YouTubeChatMessageListener listener)
    {
        if (this.listeners.contains(listener))
        {
            ...
            ModLogger.printYTMessage(StreamChat.json.text("Stopped receiving live chat message").setStyle(StreamChat.json.white()), ConfigManager.getInstance().getRightSideChat());
