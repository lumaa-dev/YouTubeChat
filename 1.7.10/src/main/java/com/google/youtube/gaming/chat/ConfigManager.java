...
public class ConfigManager
{
    ...
    private static List<String> addGeneralSetting()
    {
        ...
        prop.comment = "Put your fancy unicode, it will display in front of your channel";
        ...
        prop.comment = "Put your fancy unicode, it will display in front of moderator channel";
        ...
        prop.comment = "Put the list of rude word, this will be automatically do an action with message when received. split by \",\"";
        ...
        prop.comment = "If the message contain rude word, this will does an action with selected action";
        ...
        prop.comment = "Display super chats only";
        ...
        prop.comment = "Move only YouTube Chat into Right Side of the screen";
